...
var scoreSaved01 = $("<div>").addClass("scoreSaved01");
var scoreSavedVal01 = "Saved Score 00";
var scoreSaved02 = $("<div>").addClass("scoreSaved02");
...
function loadQuestion(){
    ...
    questionResponse01.text(quiz.data[dataIndex].responses[1]).attr('id', "incorrect");
    questionResponse03.text(quiz.data[dataIndex].responses[2]).attr('id', "incorrect");
    questionResponse02.text(quiz.data[dataIndex].responses[3]).attr('id', "incorrect");
    }
    else{
...
timeBox.text("Time Remaining")
timeBox.append(timer);
timer.text(timerVal);

timerVal = setInterval(loadTimer,1000);
...
$("#correct").on("click", function (){
    ...
    saveBtn.on("click", function (){
        ...
        $(".scoreSaved").text(userName + ": " + score + " / 6");
        count = 0;
        scoreSavedVal02 = (localStorage.getItem("Saved_Score03"));
        localStorage.setItem("Saved_Score04", (scoreSavedVal02));
        scoreSavedVal01 = (localStorage.getItem("Saved_Score02"));
        localStorage.setItem("Saved_Score03", (scoreSavedVal01));
